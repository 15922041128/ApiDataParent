...
/** 短信服务接口(美圣实现) */
@Service("ms_smsServiceImpl")
public class MS_SMSServiceImpl implements SMSService{

		//账号
		static String account = "JSM41516";
		//密码
		static String password = "qenrxgj7";
		//校验码
		static String veryCode = "jqwa1ctjauzt";
		//接口地址
		...
		public void send(String phoneNo, String vCode) throws Exception {
			...
			sb.append("@1@=" + vCode);
			sb.append(",@2@=1");
			sendTplSms(phoneNo,"JSM41516-0001", sb.toString());
		}
