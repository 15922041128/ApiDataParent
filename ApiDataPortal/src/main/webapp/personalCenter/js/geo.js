...
function change(v,p_city,p_town) {
    ...
    with (ss) {
        ...
        if (++v < s.length) {change(v,p_city,p_town);}
    }
}
...
dsy.add("0_19_11", ["沙田镇","常平镇","东城区","高埗镇","石龙镇","东坑镇","南城区","横沥镇","大岭山镇","松山湖","望牛墩镇","寮步镇","长安镇","樟木头镇","谢岗镇","凤岗镇","道滘镇","大朗镇","桥头镇","中堂镇","麻涌镇","清溪镇","塘厦镇","洪梅镇","莞城区","虎门镇","万江区","黄江镇","石排镇","厚街镇","企石镇","茶山镇","石碣镇"]);
...
dsy.add("0_21_1", ["海棠区", "吉阳区", "琼山区", "崖州区"]);
